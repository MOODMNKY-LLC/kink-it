...
// KINK IT Assistant - General purpose assistant
export const kinkItAssistant = new Agent({
  name: "KINK IT Assistant",
  instructions: `You are a helpful assistant for KINK IT, a D/s relationship management application.
...
Always maintain a respectful, professional, and supportive tone. Be knowledgeable about BDSM/kink terminology and practices, but never assume a user's experience level.`,
  model: "gpt-4o-mini",
})
