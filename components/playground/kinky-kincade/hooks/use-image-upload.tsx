/**
 * Hook for handling image uploads in Kinky Kincade Playground
 * Supports drag-drop, file picker, URL input, and HEIC conversion
 */
...
export function useImageUpload() {
  ...
  const convertHeicToPng = async (file: File): Promise<File> => {
    try {
      ...
      // Dynamic import to avoid loading heic-to if not needed
