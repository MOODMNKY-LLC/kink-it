/**
 * Hook for managing generation history with localStorage persistence
 * Adapted from nano banana pro with KINK-IT enhancements
 */
...
const STORAGE_KEY = "kinky_kincade_generations"
const MAX_STORED = 50
...
export function useGenerationHistory(
  ...
  const deleteGeneration = async (id: string) => {
    ...
    onToast?.("Generation deleted", "success")
  }
